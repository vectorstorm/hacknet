...
/* potions ... */
POTION("gain ability", "ruby",          1, GAIN_ABIL,  42, 300, CLR_RED),
POTION("restore ability", "pink",       1, REST_ABIL,  40, 100, CLR_BRIGHT_MAGENTA),
POTION("confusion", "orange",           1, CONFUSION,  42, 100, CLR_ORANGE),
POTION("blindness", "yellow",           1, BLINDED,    40, 150, CLR_YELLOW),
POTION("paralysis", "emerald",          1, PARALYSE,   42, 300, CLR_BRIGHT_GREEN),
...
POTION("healing", "purple-red",         1, HEAL,       57, 100, CLR_MAGENTA),
POTION("extra healing", "puce",         1, EXTRA_HEAL, 47, 100, CLR_RED),
POTION("gain level", "milky",           1, GAIN_LEVEL, 20, 300, CLR_WHITE),
POTION("enlightenment", "swirly",       1, ENLIGHTEN,  20, 200, CLR_BROWN),
POTION("monster detection", "bubbly",   1, MONST_DET,  40, 150, CLR_WHITE),
POTION("object detection", "smoky",     1, OBJ_DET,    42, 150, CLR_GRAY),
POTION("gain energy", "cloudy",         1, GAIN_ENERGY,42, 150, CLR_WHITE),
POTION("sleeping",  "effervescent",     1, SLEEP,      42, 100, CLR_GRAY),
POTION("full healing",  "black",        1, FULL_HEAL,  10, 200, CLR_BLACK),
POTION("polymorph", "golden",           1, POLYMORPH,  10, 200, CLR_YELLOW),
POTION("booze", "brown",                0, BOOZE,      42,  50, CLR_BROWN),
POTION("sickness", "fizzy",             0, SICKNESS,   42,  50, CLR_CYAN),
POTION("fruit juice", "dark",           0, JUICE,      42,  50, CLR_BLACK),
POTION("acid", "white",                 0, ACID,       10, 250, CLR_WHITE),
POTION("oil", "murky",                  0, OIL,        30, 250, CLR_BROWN),
POTION("water", "clear",                0, WATER,          92, 100, CLR_CYAN),
